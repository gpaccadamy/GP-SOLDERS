...
import { FiArrowLeft, FiAward, FiLogOut, FiCheckCircle, FiXCircle, FiClock } from "react-icons/fi";
...
const styles = {
  ...
  backBtn: { background: "none", border: "none", color: "#e2e8f0", cursor: "pointer" },
